        ...
        >
          <div className='flex flex-col gap-2 justify-start items-stretch  md:w-[500px] p-4'>
            ...
            <div className='font-light text-lg'>
              ...
              laboriosam incidunt explicabo ipsam corporis iste dicta sit,
              voluptatum mollitia eum doloremque laborum alias deleniti sint,
              debitis ratione quae animi recusandae?
            </div>
          </div>
